...
function barcode( $filepath="", $text="0", $size="20", $orientation="horizontal", $code_type="code128", $print=false, $SizeFactor=1 ) {
    ...
    $image = imagecreate($img_width, $img_height + $text_height - 10);// or die("Cannot Initialize new GD image stream");
    ...
    for ( $position = 1 ; $position <= strlen($code_string); $position++ ) {
        ...
        if ( strtolower($orientation) == "horizontal" )
            imagefilledrectangle( $image, $location*$SizeFactor, 5, $cur_size*$SizeFactor, $img_height, ($position % 2 == 0 ? $white : $black) );
        else
